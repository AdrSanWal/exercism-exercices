...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    alc = set(drink_ingredients).intersection(ALCOHOLS)
    drink = 'Cocktail' if alc else 'Mocktail'
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    """
    CATEGORY = {'VEGAN': VEGAN, 'VEGETARIAN': VEGETARIAN,
                'PALEO': PALEO, 'KETO': KETO, 'OMNIVORE': OMNIVORE}
    for c in CATEGORY:
        if len(CATEGORY[c] & dish_ingredients) == len(dish_ingredients):
